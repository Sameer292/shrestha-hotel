...
# NOTE: persistent path, NOT the theme dir — theme updates wipe custom files
docker compose exec wordpress mkdir -p /var/www/html/wp-content/sh-acf-json
docker compose cp scripts/acf-json/. wordpress:/var/www/html/wp-content/sh-acf-json/
